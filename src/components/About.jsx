        ...
        <div>
            ...
            <div className="wrapper">
                ...
                <p className="main__wrapper-about">
                    ...
                    В <span className="secondary">1930</span> году город переименован в Сыктывкар. Это название в переводе с коми языка
                    означает – «город на Сысоле».
                    <br/> <br/>
                    Сыктывкар является административным центром Республики Коми.
                    <br/> <br/>
                    Город расположен на северо-востоке Европейской части России в <span className="secondary">1410</span> км к северо-востоку
                    ...
                    className="red">плюс 17</span> градусов С. Осадков выпадает около <span className="secondary">650</span> мм в год.
                    <br/> <br/>
                    Сыктывкар — многонациональный город. Здесь проживает около <span className="secondary">250</span> тысяч жителей – это
                    представители более <span className="secondary">70</span> национальностей. В городе действуют различные национальные
                    общества.
                    <br/> <br/>
                    Сыктывкар — большой промышленный центр. В городе работает около <span className="secondary">40</span> промышленных
                    ...
                    насчитывается порядка <span className="secondary">30</span> специализированных учреждений, осуществляющих
                    ...
                    Университет <span className="secondary">им. Питирима Сорокина</span>, Коми государственный педагогический институт,
                    ...
                    училище <span className="secondary">№2</span>, Республиканское училище искусств, Сыктывкарский кооперативный техникум,
                    ...
                    академический театр драмы <span className="secondary">им. В. А. Савина</span>, а также один из любимых центров культуры
                    ...
                    Республики Коми. Широкую известность за пределами республики имеет геологический музей <span className="secondary">им. А. А. Чернова</span>.
