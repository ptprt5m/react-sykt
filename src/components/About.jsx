        ...
        <div>
            ...
            <div className="wrapper">
                ...
                <p className="main__wrapper-about">
                    Город основан <span className="span">5 февраля 1780 года</span> по Указу Екатерины II.
                    Первоначальное его название — <span className="span">Усть-Сысольск</span>.
                    В <span className="span">1930</span> году город переименован в Сыктывкар. Это название в переводе с коми языка
                    означает – «город на Сысоле».
                    <br/> <br/>
                    Сыктывкар является административным центром Республики Коми.
                    <br/> <br/>
                    Город расположен на северо-востоке Европейской части России в <span className="span">1410</span> км к северо-востоку
                    от Москвы. Сыктывкар раскинулся на берегах двух рек — Сысолы и Вычегды в окружении лесов. Общая
                    площадь города составляет <span className="span">152</span> кв. км.
                    <br/> <br/>
                    ...
                    className="red">плюс 17</span> градусов С. Осадков выпадает около <span className="span">650</span> мм в год.
                    <br/> <br/>
                    Сыктывкар — многонациональный город. Здесь проживает около <span className="span">250</span> тысяч жителей – это
                    представители более <span className="span">70</span> национальностей. В городе действуют различные национальные
                    общества.
                    <br/> <br/>
                    Сыктывкар — большой промышленный центр. В городе работает около <span className="span">40</span> промышленных
                    ...
                    className="purple">ОАО</span> «Монди Сыктывкарский ЛПК», <span
                    className="purple">ОАО</span> «Сыктывкар Тиссью Групп» — одна из ведущих российский компаний по
                    производству санитарно-гигиенической продукции, <span className="purple">ОАО</span> «Комитекс»
                    — фабрика нетканых материалов, <span className="purple">ООО</span> «Сыктывкарский фанерный
                    завод», <span className="purple">ОАО</span> «Сыктывкарский ликеро-водочный завод» — ведущий
                    ...
                    насчитывается порядка <span className="span">30</span> специализированных учреждений, осуществляющих
                    ...
                    Университет <span className="span">им. Питирима Сорокина</span>, Коми государственный педагогический институт,
                    ...
                    училище <span className="span">№2</span>, Республиканское училище искусств, Сыктывкарский кооперативный техникум,
                    ...
                    академический театр драмы <span className="span">им. В. А. Савина</span>, а также один из любимых центров культуры
                    ...
                    Республики Коми. Широкую известность за пределами республики имеет геологический музей <span className="span">им. А. А. Чернова</span>.
                    ...
                    className="purple">Китай, провинция Шанси</span>), г. Лос-Алтос (<span
                    className="purple">США</span>), г. Кулльера (<span className="purple">Испания</span>), г.
                    Дебрецен (<span className="purple">Венгрия</span>) и г. Ловеч (<span
                    className="purple">Болгария</span>).
                </p>
            </div>
        </div>
    )
